package com.wahyudif55121078.firestore;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mListText = findViewById(R.id.textView);
        ...
        mSaveBtn.setOnClickListener(view -> {
                ...
                mFirestore.collection("pengguna").add(userMap).addOnSuccessListener
                        (documentReference -> {
                            Toast.makeText(MainActivity.this,
                                    "Pengguna Ditambahkan di Firestore",
            ...
            mListText.setOnClickListener(v -> {
                ...
                Toast.makeText(MainActivity.this,
                        "Buka Activity yang menampilkan ListView",
                        Toast.LENGTH_SHORT).show();
            });
        });
    }
